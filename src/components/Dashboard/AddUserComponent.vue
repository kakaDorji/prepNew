        ...
        <div class="relative bg-white shadow-lg sm:rounded-3xl sm:p-20">
          <div class="max-w-md mx-auto">
            ...
            <form @submit.prevent="submitForm" class="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option
                    v-for="location in prepLocations"
                    :key="location"
                    :value="location"
                  >
                    {{ location }}
            ...
            <div class="space-y-4 mb-6">
              ...
              <div
                v-if="errorMessage"
                class="p-4 bg-red-100 border border-red-400 text-red-700 rounded-lg text-center"
              >
                {{ errorMessage }}
              </div>
            </div>
