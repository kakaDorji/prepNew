<template>
  <div class="flex flex-col justify-center min-h-screen bg-gradient-to-r from-indigo-950 to-indigo-700">
    <!-- Using max-w-6xl from your original code, which is fine -->
    <div class="relative py-3 max-w-6xl w-full mx-auto px-4">
      ...
      <!-- MODIFICATION 1: Reduced padding from p-20/py-10 to p-6/py-6 to reduce overall height -->
      <div class="relative px-6 py-6 bg-white shadow-lg sm:rounded-3xl sm:p-6">
        <!-- MODIFICATION 2: Reduced bottom margin from mb-8 to mb-6 -->
          ...
          <table v-if="paginatedUsers.length > 0" class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="user in paginatedUsers" :key="user.username"
                ...
                <!-- MODIFICATION 3: Reduced row height by changing py-4 to py-2 -->
        ...
        <!-- Delete confirmation box (using your original code for this) -->
