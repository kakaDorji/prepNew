  ...
  <teleport to="body">
    <div class="modal-overlay" @click.self="emitCancel">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="modal-title-form6"
      >
        <!-- Modal Header -->
        <div class="modal-header">
          <h2 id="modal-title-form6">
            <i class="fas fa-sign-out-alt"></i> Review Exit Form Details
          </h2>
          <button
            @click="emitCancel"
        ...
        <div class="modal-body">
          <p class="modal-instruction">
            Please confirm the following Exit Form information before
            submitting:
          </p>
          ...
          <div v-if="formData" class="modal-details-grid">
            ...
            <div
              v-if="formData.live_with_partner === 'Yes'"
            ...
            <div class="detail-item full-width">
              ...
              >
              <span class="detail-value list-value">{{
                formatArrayValue(formData.sex_days)
              }}</span>
            </div>
            <div
              class="detail-item"
              v-if="formData.no_sex_with_regular_partner"
            >
              <span class="detail-label">No Sex (Regular - Last Week):</span>
              <span class="detail-value">{{
                formData.no_sex_with_regular_partner
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label"
                >Condom Use (Regular Clients - Last Week):</span
              >
              <span class="detail-value">{{
                formData.regular_condom_use || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label"
              ...
              >
              <span class="detail-value">{{
                formData.last_sex_condom_use || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-handshake"></i> Have Clients:</span
              >
              <span class="detail-value">{{
                formData.have_clients || "N/A"
              }}</span>
            </div>
            <div v-if="formData.have_clients === 'Yes'">
              <div class="detail-item">
                ...
                ><span class="detail-value">{{
                  formData.clients_last_week ?? "N/A"
                }}</span>
              </div>
              <div class="detail-item full-width">
                <span class="detail-label">Days Sex (Clients - Last Week):</span
                ><span class="detail-value list-value">{{
                  formatArrayValue(formData.sex_days_clients)
                }}</span>
              </div>
              <div class="detail-item" v-if="formData.no_sex_with_clients">
                <span class="detail-label">No Sex (Clients - Last Week):</span
                ><span class="detail-value">{{
                  formData.no_sex_with_clients
                }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label"
                  >Condom Use (Clients - Last Week):</span
                ><span class="detail-value">{{
                  formData.clients_condom_use || "N/A"
                }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Condom (Last Sex - Clients):</span
                ><span class="detail-value">{{
                  formData.last_sex_with_clients_condom_use || "N/A"
                }}</span>
              </div>
            </div>
            <div class="detail-item full-width">
              ...
              <span class="detail-value list-value">
                ...
                <span
                  v-if="
                    formData.sex_without_condom_reason.includes('Other') &&
                    formData.sex_without_condom_reason_other
                  "
                >
                  (Other: {{ formData.sex_without_condom_reason_other }})</span
                >
              </span>
            </div>
            <div class="detail-item">
            ...
            <div class="detail-item">
              <span class="detail-label">Prescribed Regimen:</span
              ><span class="detail-value">{{
                formData.dosing_regimen || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">Changed Regimen?:</span
              ><span class="detail-value">{{
            ...
            <template v-if="formData.dosing_regimen === 'Daily PrEP'">
              ...
              <div class="detail-item">
                ...
                ><span class="detail-value"
                  ...
                  }}<span v-if="formData.prep_reason === 'Other'">
              ...
              <div class="detail-item">
                <span class="detail-label">Pill Time:</span
                ><span class="detail-value"
                  >{{ formData.pill_time || "N/A"
                  }}<span v-if="formData.pill_time === 'Other'">
                    ({{ formData.pill_time_other }})</span
                  ></span
                >
              </div>
              <div class="detail-item">
                <span class="detail-label">Same Time?:</span
                ><span class="detail-value">{{
              ...
              <div class="detail-item">
                ...
                ><span class="detail-value"
                  ...
                  }}<span v-if="formData.pill_reminder === 'Other'">
                    ({{ formData.pill_reminder_other }})</span
                  ></span
                >
              </div>
              <div class="detail-item full-width">
                <span class="detail-label">Reasons Missed:</span
                ><span class="detail-value list-value"
                  >{{ formatArrayValue(formData.missed_pill_reasons)
                  }}<span v-if="formData.missed_pill_reasons.includes('Other')">
                    (Other: {{ formData.missed_pill_other_reason }})</span
                  ></span
                >
              </div>
              <div class="detail-item">
                <span class="detail-label">Longest Missed Streak:</span
                ><span class="detail-value">{{
            ...
            <template v-if="formData.dosing_regimen === 'Event-Driven PrEP'">
              ...
              <div class="detail-item">
                ...
                ><span class="detail-value"
                  ...
                  }}<span v-if="formData.ed_prep_reason === 'Other'">
              ...
              <div class="detail-item">
                <span class="detail-label">PrEP Before (%):</span
                ><span class="detail-value">{{
                  formData.prep_before_sex || "N/A"
                }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">PrEP After (%):</span
                ><span class="detail-value">{{
                  formData.prep_after_sex || "N/A"
                }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">1st Dose After (%):</span
                ><span class="detail-value">{{
                  formData.first_prep_after_sex || "N/A"
                }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">2nd Dose After (%):</span
                ><span class="detail-value">{{
              ...
              <div class="detail-item">
                ...
                ><span class="detail-value"
                  ...
                  }}<span v-if="formData.prep_before_last_sex === 'Other'">
              ...
              <div class="detail-item">
                ...
                ><span class="detail-value"
                  ...
                  }}<span v-if="formData.prep_after_last_sex === 'Other'">
            ...
            <div class="detail-item full-width">
              <span class="detail-label">Remembering Methods:</span
              ><span class="detail-value list-value"
                >{{ formatArrayValue(formData.pill_remember)
                }}<span v-if="formData.pill_remember.includes('Other')">
                  (Other: {{ formData.pill_remember_other }})</span
                ></span
              >
            </div>
            <div class="detail-item full-width">
              <span class="detail-label">Missed Pills Status:</span
              ><span class="detail-value list-value">{{
            ...
            <div class="detail-item">
              <span class="detail-label">Ease of Remembering:</span
              ><span class="detail-value">{{
                formData.pill_remember_difficulty || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">Pills Shared:</span
              ><span class="detail-value">{{
            ...
            <div class="detail-item full-width">
              ...
              ><span class="detail-value list-value"
                ...
                }}<span v-if="formData.pill_recipient.includes('Other')">
            ...
            <div class="detail-item">
              <span class="detail-label">Visited Pride (3m):</span
              ><span class="detail-value">{{
            ...
            <div class="detail-item">
              <span class="detail-label">Met ORW (M1):</span
              ><span class="detail-value">{{
                formData.orw_meeting_one || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">Received Condoms (HISC):</span
              ><span class="detail-value">{{
                formData.received_condoms || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">Received Lubricants (HISC):</span
              ><span class="detail-value">{{
            ...
            <div class="detail-item">
              <span class="detail-label">Alcohol Use (3m):</span
              ><span class="detail-value">{{
            ...
            <div class="detail-item">
              <span class="detail-label">Recreational Drugs (12m):</span
              ><span class="detail-value">{{
            ...
            <div v-if="formData.taken_drugs === 'Yes'">
              <div class="detail-item">
                <span class="detail-label">Drugs Before/During Sex:</span
                ><span class="detail-value">{{
            ...
            <div class="detail-item">
              <span class="detail-label">Feeling Protected:</span
              ><span class="detail-value">{{
                formData.protection_feeling || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">STI Concern:</span
              ><span class="detail-value">{{
                formData.sti_concern || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">PrEP Package Opinion:</span
              ><span class="detail-value">{{
                formData.prep_package_opinion || "N/A"
              }}</span>
            </div>
            <div class="detail-item full-width">
              <span class="detail-label">Likes:</span
              ><span class="detail-value list-value"
                >{{ formatArrayValue(formData.participation_likes)
                }}<span v-if="formData.participation_likes.includes('Other')">
                  (Other: {{ formData.participation_likes_other }})</span
                ></span
              >
            </div>
            <div class="detail-item full-width">
              ...
              ><span class="detail-value list-value"
                >{{ formatArrayValue(formData.participation_challenges)
                }}<span
                  v-if="formData.participation_challenges.includes('Other')"
                >
                  (Other: {{ formData.participation_challenges_other }})</span
                ></span
              >
            </div>
            <div class="detail-item full-width">
              ...
              ><span class="detail-value list-value"
                >{{ formatArrayValue(formData.delivery_preference)
                }}<span
                  v-if="formData.delivery_preference.includes('Other methods')"
                >
                  (Other: {{ formData.delivery_preference_other }})</span
                ></span
              >
            </div>
            <div class="detail-item">
              ...
              ><span class="detail-value">{{
                formData.satisfaction_level || "N/A"
              }}</span>
            </div>
            ...
            <div class="detail-item full-width">
              ...
              ><span class="detail-value list-value"
                >{{ formatArrayValue(formData.discontinuation_reasons)
                }}<span
                  v-if="formData.discontinuation_reasons.includes('Other')"
                >
                  (Other: {{ formData.discontinuation_other }})</span
                ></span
              >
            </div>
          </div>
