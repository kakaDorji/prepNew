  ...
  <div class="modal-overlay">
    <div class="modal-content enhanced-modal">
        ...
        <div v-if="formData" class="modal-details-grid">
          ...
          <div class="detail-item">
            <span class="detail-label"
              ><i class="fas fa-user-nurse"></i> Outreach Worker:</span
            >
            <span class="detail-value">{{ formData.orw || "N/A" }}</span>
          </div>
          <div class="detail-item">
            <span class="detail-label"
              ><i class="fas fa-map-marker-alt"></i> Referring Site:</span
            >
            <span class="detail-value">{{
              formData.referred_site || "N/A"
            }}</span>
          </div>
          <div class="detail-item">
            <span class="detail-label"
              ><i class="fas fa-calendar-day"></i> Submission Date:</span
            >
            <span class="detail-value">{{ formData.date || "N/A" }}</span>
          </div>
          <div class="detail-item">
            <span class="detail-label"
              ><i class="fas fa-calendar-alt"></i> Form Month:</span
            >
          ...
          <div class="detail-item">
            <span class="detail-label"
              ><i class="fas fa-mobile-alt"></i> Mobile No.:</span
            >
            <span class="detail-value">{{ formData.mobile_no || "N/A" }}</span>
          </div>
          <div class="detail-item">
            <span class="detail-label"
              ><i class="fas fa-id-card"></i> CID / SRP / Other:</span
            >
            <span class="detail-value">{{ formData.cid_other || "N/A" }}</span>
          </div>
          <div class="detail-item highlight">
            <span class="detail-label"
              ><i class="fas fa-fingerprint"></i> Generated UID:</span
            >
          ...
          <div class="detail-item">
            <span class="detail-label"
              ><i class="fas fa-hospital"></i> Referral to PrEP Site:</span
            >
            <span class="detail-value">{{
              formData.referral_prep_site || "N/A"
            }}</span>
          </div>
          <div class="detail-item">
            <span class="detail-label"
              ><i class="fas fa-calendar-check"></i> Appointment Date:</span
            >
            <span class="detail-value">{{
              formData.referral_date || "N/A"
            }}</span>
          </div>
        </div>
        <div v-else>
      ...
      <div class="modal-footer">
        <button
          @click="$emit('cancel')"
          class="cancel-btn modal-cancel-btn"
          :disabled="isSubmitting"
        >
