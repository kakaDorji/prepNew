  ...
  <teleport to="body">
    <div class="modal-overlay" @click.self="emitCancel">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="modal-title-form3"
      >
        <!-- Modal Header -->
          ...
          <div v-if="formData" class="modal-details-grid">
            ...
            <template v-for="symptom in acuteSymptoms" :key="symptom.key">
              <div v-if="formData[symptom.key] === 'Yes'" class="symptom-group">
                ...
                <div class="detail-item">
                  <span class="detail-label">Specify:</span
                  ><span class="detail-value">{{
                ...
                <div class="detail-item">
                  <span class="detail-label">Present on Exam:</span
                  ><span class="detail-value">{{
            ...
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-exclamation-circle"></i> Recent HIV
                Exposure:</span
              >
              <span class="detail-value">{{
            ...
            <div
              v-if="formData.recent_hiv_exposure === 'Yes'"
            ...
            <template v-for="symptom in stisymptoms" :key="symptom.key">
              <div v-if="formData[symptom.key] === 'Yes'" class="symptom-group">
                ...
                <div class="detail-item">
                  <span class="detail-label">Treatment/Referral:</span
                  ><span class="detail-value">{{
            ...
            <div class="detail-item">
              <span class="detail-label">Acute HIV Specify:</span
              ><span class="detail-value">{{
                formData.acute_hiv_specify || "None"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">STI Specify:</span
              ><span class="detail-value">{{
                formData.sti_specify || "None"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">Others Specify:</span
              ><span class="detail-value">{{
            ...
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-notes-medical"></i> Disease History:</span
              >
              <span class="detail-value">{{
            ...
            <div
              v-if="formData.disease_history === 'Yes'"
              class="detail-item full-width"
            >
            ...
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-pills"></i> Current Medications:</span
              >
              <span class="detail-value">{{
            ...
            <div
              v-if="formData.current_medications === 'Yes'"
              class="detail-item full-width"
            >
            ...
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-allergies"></i> Medication Allergies:</span
              >
              <span class="detail-value">{{
            ...
            <div
              v-if="formData.medication_allergies === 'Yes'"
              class="detail-item full-width"
            >
            ...
            <div class="detail-item">
              <span class="detail-label">HIV Rapid:</span
              ><span class="detail-value">{{
                formData.hiv_rapid_sample_date || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">HIV 4th Gen:</span
              ><span class="detail-value">{{
                formData.hiv_4th_sample_date || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">Hep B (HBsAg):</span
              ><span class="detail-value">{{
                formData.hepatitis_b_sample_date || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">Hep C (Anti-HCV):</span
              ><span class="detail-value">{{
                formData.hepatitis_C_sample_date || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">Syphilis:</span
              ><span class="detail-value">{{
                formData.syphilis_sample_date || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">Kidney (Creatinine):</span
              ><span class="detail-value">{{
                formData.kidney_function_sample_date || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">Gonorrhoea:</span
              ><span class="detail-value">{{
            ...
            <div class="detail-item full-width">
              <span class="detail-label"
                ><i class="fas fa-comment-medical"></i> Assessment Notes:</span
              >
              <span class="detail-value pre-wrap">{{
            ...
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-box-open"></i> PrEP Dispensed:</span
              >
              <span class="detail-value">{{
            ...
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-calendar-check"></i> Clinician Info
                Date:</span
              >
              <span class="detail-value">{{
            ...
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-user-md"></i> Clinician Name:</span
              >
              <span class="detail-value">{{
            ...
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-id-badge"></i> Clinician Designation:</span
              >
              <span class="detail-value">{{
            ...
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-hashtag"></i> BHMC Registration:</span
              >
              <span class="detail-value">{{
...
.modal-content.enhanced-modal {
  ...
  width: 100%;
  max-width: 800px; /* Wider for more details */
  max-height: 90vh;
  display: flex;
...
.symptom-group > h5 {
  /* Style subsection titles within the grid */
  grid-column: 1 / -1;
}
