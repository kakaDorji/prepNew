<template>
  <div class="container">
    ...
    <div class="p-6 form-container">
      <!-- Added form-container class for consistency -->
      <div class="flex flex-wrap items-center justify-center gap-4 mb-6">
        <div class="flex items-center gap-4">
          <label for="search_uid" class="font-semibold text-gray-700"
            >UID:</label
          >
          <input
            v-model="searchUid"
        ...
        <div class="ml-6 flex items-center gap-6">
          <label for="search_type_of_visit" class="font-semibold text-gray-700"
            >Type of Visit:</label
          >
          <select
            v-model="searchTypeOfVisit"
            id="search_type_of_visit"
            name="search_type_of_visit"
            class="border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
      ...
      <span v-if="loading && !statusMessage" class="loading-status"
        >Loading...</span
      >
      ...
      >
        ...
        <span
          v-if="statusClass === 'success' && formData.hiv_rapid_sample_date"
        >
    ...
    <form @submit.prevent="showReviewModal">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <input
                    type="date"
                    v-model="formData.hiv_rapid_sample_date"
                    readonly
                  />
                </td>
                <td>
                  <input type="date" v-model="formData.hiv_rapid_result_date" />
                </td>
                <td>
                  <div class="radio-group-inline">
                    <label
                      ><input
                        type="radio"
                        name="hiv_rapid_result"
                        v-model="formData.hiv_rapid_result"
                        value="Negative"
                      />
                      Neg</label
                    >
                ...
                <td>
                  <textarea
                    v-model="formData.hiv_rapid_notes"
                    rows="1"
                    placeholder="Notes"
                  ></textarea>
                </td>
              ...
              <tr>
                ...
                <td>
                  <input
                    type="date"
                    v-model="formData.hiv_4th_sample_date"
                    readonly
                  />
                </td>
                <td>
                  <input type="date" v-model="formData.hiv_4th_result_date" />
                </td>
                <td>
                  <div class="radio-group-inline">
                    <label
                      ><input
                        type="radio"
                        name="hiv_4th_result"
                        v-model="formData.hiv_4th_result"
                        value="Negative"
                      />
                      Neg</label
                    >
                ...
                <td>
                  <textarea
                    v-model="formData.hiv_4th_notes"
                    rows="1"
                    placeholder="Notes"
                  ></textarea>
                </td>
              ...
              <tr>
                ...
                <td>
                  <input
                    type="date"
                    v-model="formData.hepatitis_b_result_date"
                  />
                </td>
                <td>
                  <div class="radio-group-inline">
                    <label
                      ><input
                        type="radio"
                        name="hep_b_result"
                        v-model="formData.hepatitis_b_result"
                        value="Negative"
                      />
                      Neg</label
                    >
                ...
                <td>
                  <textarea
                    v-model="formData.hepatitis_b_notes"
                    rows="1"
                    placeholder="Notes"
                  ></textarea>
                </td>
              ...
              <tr>
                ...
                <td>
                  <input
                    type="date"
                    v-model="formData.hepatitis_C_result_date"
                  />
                </td>
                <td>
                  <div class="radio-group-inline">
                    <label
                      ><input
                        type="radio"
                        name="hep_c_result"
                        v-model="formData.hepatitis_C_result"
                        value="Negative"
                      />
                      Neg</label
                    >
                ...
                <td>
                  <textarea
                    v-model="formData.hepatitis_C_notes"
                    rows="1"
                    placeholder="Notes"
                  ></textarea>
                </td>
              ...
              <tr>
                ...
                <td>
                  <input
                    type="date"
                    v-model="formData.syphilis_sample_date"
                    readonly
                  />
                </td>
                <td>
                  <input type="date" v-model="formData.syphilis_result_date" />
                </td>
                <td>
                  <div class="radio-group-inline">
                    <label
                      ><input
                        ...
                        v-model="formData.syphilis_result"
                        value="Negative"
                      />
                      Neg</label
                    >
                ...
                <td>
                  <textarea
                    v-model="formData.syphilis_notes"
                    rows="1"
                    placeholder="Notes"
                  ></textarea>
                </td>
              ...
              <tr>
                ...
                <td>
                  <input
                    type="date"
                    v-model="formData.kidney_function_result_date"
                  />
                </td>
                <td>
                  <input
                    type="text"
                    v-model="formData.kidney_function_result"
                    placeholder="Result (mg/dl)"
                  />
                </td>
                <td>
                  <textarea
                    v-model="formData.kidney_function_notes"
                    rows="1"
                    placeholder="Notes"
                  ></textarea>
                </td>
              ...
              <tr>
                ...
                <td>
                  <input
                    type="date"
                    v-model="formData.gonorrhoea_result_date"
                  />
                </td>
                <td>
                  <div class="radio-group-inline">
                    <label
                      ><input
                        type="radio"
                        name="gonorrhoea_result"
                        v-model="formData.gonorrhoea_result"
                        value="Negative"
                      />
                      Neg</label
                    >
                ...
                <td>
                  <textarea
                    v-model="formData.gonorrhoea_notes"
                    rows="1"
                    placeholder="Notes"
                  ></textarea>
                </td>
      ...
      >
        ...
        {{ isSubmitting ? "Submitting..." : "Review Results" }}
        <!-- Changed Text -->
      </button>
    </form>
  </div>
...
// --- Configuration ---
const SUBMIT_URL =
  "https://script.google.com/macros/s/AKfycbyA33wSBvWOEVd39rTDt_AYppcplr3Z61JJqBOVDRL9SS2VqTaScpB4N2jqr7st5HxMmQ/exec"; // FORM 8 Submit URL
const FETCH_SHEET_ID =
  "2PACX-1vSVqdLVHK4grNIbq-rX0Cz7_c-yFxDnviNyEvr8aCTwu0NIVWSXItCbJuerIi2PDPxLMQ55VYK_kNgH"; // Sheet ID (extracted EID part)
const FETCH_GID = "0";
...
const formData = ref({
  ...
  hepatitis_b_result_date: "",
  hepatitis_b_result: "",
  hepatitis_b_notes: "",
  hepatitis_C_sample_date: "",
  hepatitis_C_result_date: "",
  hepatitis_C_result: "",
  hepatitis_C_notes: "",
  syphilis_sample_date: "",
  syphilis_result_date: "",
  syphilis_result: "",
  syphilis_notes: "",
  kidney_function_sample_date: "",
  kidney_function_result_date: "",
  kidney_function_result: "",
  kidney_function_notes: "",
  gonorrhoea_sample_date: "",
  gonorrhoea_result_date: "",
  gonorrhoea_result: "",
  gonorrhoea_notes: "",
});
...
const fetchData = async () => {
  ...
  try {
    ...
    const matchedRow = rows.slice(1).find(
      (
        row, // Start from row 1 (skip header)
      ) =>
    ...
    if (matchedRow) {
      ...
      formData.value.hiv_rapid_sample_date =
        matchedRow[colHivRapidSample] || "";
      ...
      formData.value.kidney_function_sample_date =
        matchedRow[colKidneySample] || "";
      formData.value.gonorrhoea_sample_date =
        matchedRow[colGonorrheaSample] || "";
    } else {
    ...
    statusMessage.value =
      "Error fetching data. Check console or network connection.";
    statusClass.value = "error";
    clearForm();
  } finally {
    loading.value = false;
...
const clearForm = () => {
  ...
  Object.keys(formData.value).forEach((key) => {
    if (key !== "uid" && key !== "type_of_visit") {
      ...
      if (key.includes("_sample_date")) {
        // Keep sample dates loaded from search
  ...
  errorMessage.value = ""; // Clear general messages
};
