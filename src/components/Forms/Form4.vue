  ...
  <form @submit.prevent="showReviewModal">
    <div class="container">
      ...
      <div class="form-container">
        ...
        <label
          >1.4 If YES, is your sex partner male, female, or TG? (tick all that
          apply)</label
        >
      ...
      <div class="form-container">
        ...
        <div class="checkbox-group-vertical">
          <label
            ><input
              type="checkbox"
              v-model="formData.hiv_risk_management"
          ...
          <label
            ><input
              type="checkbox"
              v-model="formData.hiv_risk_management"
              value="Seek partners on HIV treatment"
            />
          ...
          <label
            ><input
              type="checkbox"
              v-model="formData.hiv_risk_management"
              value="No risk reduction strategy"
            />
          ...
          <input
            type="text"
            v-if="formData.hiv_risk_management.includes('Other')"
            v-model="formData.other_hiv_risk"
            name="other_hiv_risk"
            placeholder="Specify"
          />
        </div>
        ...
        <div class="radio-group-vertical">
          ...
          <label
            ><input
              ...
              v-model="formData.partner_hiv_status"
              name="partner_hiv_status"
              value="Partner is NOT HIV positive"
              required
            />
          ...
          <label
            ><input
              ...
              v-model="formData.partner_hiv_status"
              name="partner_hiv_status"
              value="Partner is HIV positive and on ART"
              required
            />
          ...
          <label
            ><input
              ...
              v-model="formData.partner_hiv_status"
              name="partner_hiv_status"
              value="Partner is HIV positive but NOT on ART"
              required
            />
      ...
      <div class="form-container">
        ...
        <label
          >3.1 Number of partners for anal sex (last month)? (Put 0 if
          none)</label
        >
        ...
        <label
          >3.2 Number of partners for vaginal sex (last month)? (Put 0 if
          none)</label
        >
        <div class="partner-count-group">
          <label
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label
            ...
            ><input
              type="radio"
              v-model="formData.condom_used_last_time"
              name="condom_last_steady"
              value="Yes"
              required
            />
            Yes</label
        ...
        <div class="checkbox-group-vertical">
          <label
            ><input
              type="checkbox"
              v-model="formData.days_sex_regular_partner"
              value="Day 1"
            />
        ...
        <label style="margin-top: 0.5rem"
          ><input
            type="radio"
            v-model="formData.sex_regular_partner"
            name="sex_regular_status"
            value="No sex"
          />
        ...
        <div v-if="formData.sex_regular_partner === 'Had sex'">
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                v-model="formData.condom_use_regular_clients"
                name="condom_use_reg_clients"
                value="Always"
              />
              Always (100%)</label
            >
        ...
        <div v-if="formData.transactional_partners === 'Yes'">
          ...
          <input
            type="number"
            v-model.number="formData.num_clients_last_week"
            min="0"
          />
          ...
          <div class="checkbox-group-vertical">
            <label
              ><input
                type="checkbox"
                v-model="formData.days_sex_clients"
                value="Day 1"
              />
              Day 1 (Yesterday)</label
            >
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                v-model="formData.condom_use_clients"
                name="condom_use_clients"
                value="Always"
              />
              Always (100%)</label
            >
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label
            ...
            ><input
              type="radio"
              v-model="formData.last_sex_clients_condom_use"
              name="condom_last_client"
              value="Yes"
            />
            Yes</label
          >
        ...
        <div class="checkbox-group-vertical">
          <label
            ><input
              type="checkbox"
              v-model="formData.condomless_sex_reason"
              value="Doesn't feel good"
            />
          ...
          <label
            ><input
              type="checkbox"
              v-model="formData.condomless_sex_reason"
              value="Know partner's HIV status"
            />
          ...
          <input
            type="text"
            v-if="formData.condomless_sex_reason.includes('Other')"
            v-model="formData.condomless_other_reason"
            placeholder="Specify"
          />
        </div>
        ...
        <div v-if="formData.prep_continue === 'No'">
          ...
          <div class="checkbox-group-vertical">
            <label
              ><input
                type="checkbox"
                v-model="formData.prep_discontinue_reason"
                value="Do not like taking PrEP"
              />
              Don't like</label
            >
            <label
            ...
            >
            <textarea
              v-if="formData.prep_discontinue_reason.includes('Other')"
              v-model="formData.prep_discontinue_reason_other"
              rows="3"
              placeholder="Specify"
            ></textarea>
          </div>
        ...
        <template v-if="isMonthOneVisit">
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                v-model="formData.orw_meeting_one"
                name="orw_meet_1m"
                value="None"
                required
              />
        ...
        <template v-if="!isMonthOneVisit">
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                v-model="formData.orw_meeting_three"
                name="orw_meet_3m"
                value="None"
                required
              />
