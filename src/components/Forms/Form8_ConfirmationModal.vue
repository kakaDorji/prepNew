      ...
      >
        ...
        <div class="modal-header">
          <h2 id="modal-title-form8">
            <i class="fas fa-biohazard"></i> Review Seroconversion Form Details
          </h2>
          <button
            @click="emitCancel"
        ...
        <div class="modal-body">
          <p class="modal-instruction">
            Please confirm the following Seroconversion details before
            submitting:
          </p>
          ...
          <div v-if="formData" class="modal-details-grid">
            ...
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-calendar-day"></i> Interview Date:</span
              >
              <span class="detail-value">{{
                formData.interview_date || "N/A"
              }}</span>
            </div>
            ...
            <h4 class="details-section-title">
              A. PrEP Initiation & Seroconversion Dates
            </h4>
            <div class="detail-item">
              <span class="detail-label"
            ...
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-prescription-bottle"></i> Dosing
                Regimen:</span
              >
              <span class="detail-value">{{
            ...
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-calendar-check"></i> HIV+ Test Date:</span
              >
              <span class="detail-value">{{
                formData.hiv_test_date || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-pills"></i> Client Still on PrEP?:</span
              >
              <span class="detail-value">{{
                formData.client_on_prep || "N/A"
              }}</span>
            </div>
            <div v-if="formData.client_on_prep === 'No'" class="detail-item">
              <span class="detail-label">Last PrEP Date:</span>
              <span class="detail-value">{{
                formData.last_prep_taken || "N/A"
              }}</span>
            </div>
            ...
            <template v-if="formData.dosing_regimen === 'ED-PrEP'">
              ...
              <div class="detail-item">
                ...
                <span class="detail-value">{{
                  formData.ed_prep_sex_times || "N/A"
                }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">PrEP Before Sex (%):</span>
                <span class="detail-value">{{
                  formData.ed_prep_before_sex || "N/A"
                }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">1st PrEP After Sex (%):</span>
                <span class="detail-value">{{
                  formData.ed_prep_after_sex || "N/A"
                }}</span>
                <!-- Mapped to first after -->
              </div>
              <div class="detail-item">
                <span class="detail-label">2nd PrEP After Sex (%):</span>
                <span class="detail-value">{{
                  formData.ed_prep_2ndafter_sex || "N/A"
                }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Partner HIV Status:</span>
                <span class="detail-value">{{
                  formData.ed_prep_partner_hiv_status || "N/A"
                }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Condom Use:</span>
                <span class="detail-value">{{
                  formData.ed_prep_condom_use || "N/A"
                }}</span>
              </div>
              <div class="detail-item full-width">
                <span class="detail-label">Comments:</span>
                <span class="detail-value pre-wrap">{{
                  formData.ed_prep_seroconversion_comments || "None"
                }}</span>
              </div>
            </template>
            ...
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-calendar-check"></i> Reporting Date:</span
              >
              <span class="detail-value">{{
                formData.reporting_date || "N/A"
              }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label"
                ><i class="fas fa-user-md"></i> Name:</span
              >
            ...
            <div class="detail-item">
              ...
              >
              <span class="detail-value">{{
                formData.bmhc_registration || "N/A"
              }}</span>
            </div>
          </div>
