  ...
  <form @submit.prevent="showReviewModal">
    ...
    <div class="container">
      ...
      <div class="form-container">
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.occupation_status"
          ...
          <input
            type="text"
            v-if="formData.occupation_status === 'Other'"
            v-model="formData.occupation_other"
        ...
        <div class="radio-group-vertical">
          ...
          <input
            ...
            v-model="formData.marital_other"
            placeholder="Specify if other"
          />
        </div>
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label
            ...
            ><input
              type="radio"
              v-model="formData.live_with_partner"
              name="live_partner"
              value="Yes"
              required
            />
        ...
        <div v-if="formData.live_with_partner === 'Yes'">
          <label
            >1.4 If so, is your sex partner male, female, or TG? (tick all that
            apply):</label
          >
      ...
      <div class="form-container">
        ...
        <div class="checkbox-group-vertical">
          <label
            ><input type="checkbox" v-model="formData.sex_days" value="Day 1" />
            Day 1 (Yesterday)</label
          >
          <label
            ><input type="checkbox" v-model="formData.sex_days" value="Day 2" />
            Day 2</label
          >
          <label
            ><input type="checkbox" v-model="formData.sex_days" value="Day 3" />
            Day 3</label
          >
          <label
            ><input type="checkbox" v-model="formData.sex_days" value="Day 4" />
            Day 4</label
          >
          <label
            ><input type="checkbox" v-model="formData.sex_days" value="Day 5" />
            Day 5</label
          >
          <label
            ><input type="checkbox" v-model="formData.sex_days" value="Day 6" />
            Day 6</label
          >
          <label
            ><input type="checkbox" v-model="formData.sex_days" value="Day 7" />
            Day 7</label
          >
        </div>
        <label style="margin-top: 0.5rem"
          ><input
            type="radio"
            v-model="formData.no_sex_with_regular_partner"
            name="no_sex_regular"
            value="No"
            required
          />
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.regular_condom_use"
              name="reg_condom_use"
              value="Always"
              required
            />
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label
            ...
            ><input
              type="radio"
              v-model="formData.last_sex_condom_use"
              name="last_sex_condom_reg"
              value="Yes"
              required
            />
            Yes</label
        ...
        <div v-if="formData.have_clients === 'Yes'">
          ...
          <input
            type="number"
            v-model.number="formData.clients_last_week"
            min="0"
            required
          />
          ...
          <div class="checkbox-group-vertical">
            <label
              ><input
                type="checkbox"
                v-model="formData.sex_days_clients"
                value="Day 1"
              />
              Day 1</label
            >
          ...
          <label style="margin-top: 0.5rem"
            ><input
              type="radio"
              v-model="formData.no_sex_with_clients"
              name="no_sex_client"
              value="No"
              required
            />
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                v-model="formData.clients_condom_use"
                name="client_condom_use"
                value="Always"
                required
              />
              Always</label
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label
              ...
              ><input
                type="radio"
                v-model="formData.last_sex_with_clients_condom_use"
                name="last_sex_condom_client"
                value="Yes"
                required
              />
              Yes</label
        ...
        <div class="checkbox-group-vertical">
          <label
            ><input
              type="checkbox"
              v-model="formData.sex_without_condom_reason"
          ...
          <input
            type="text"
            v-if="formData.sex_without_condom_reason.includes('Other')"
            v-model="formData.sex_without_condom_reason_other"
            placeholder="Specify"
          />
        </div>
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label
            ...
            ><input
              type="radio"
              v-model="formData.prep_change_condom_use"
              name="prep_change_condom"
              value="Yes"
              required
            />
            Yes</label
      ...
      <div class="form-container">
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.dosing_regimen"
              name="dosing_regimen"
              value="Daily PrEP"
              required
            />
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label
            ...
            ><input
              type="radio"
              v-model="formData.change_regimen"
              name="change_regimen"
              value="Yes"
            />
            Yes</label
        ...
        <div v-if="formData.change_regimen === 'Yes'">
          ...
          <textarea
            v-model="formData.reason_change"
            id="reason_change"
            rows="4"
          ></textarea>
        </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <input
                    type="radio"
                    name="abdo_pain"
                    v-model="formData.abdominal_pain"
                    value="Yes"
                  />
                </td>
                <td>
                ...
                <td>
                  <input
                    type="checkbox"
                    v-model="formData.abdominal_pain_ongoing"
                    :disabled="
                      formData.abdominal_pain !== 'Yes' ||
                ...
                <td>
                  <input
                    type="checkbox"
                    v-model="formData.abdominal_pain_resolved"
                    :disabled="
                      formData.abdominal_pain !== 'Yes' ||
              ...
              <tr>
                ...
                <td>
                  <input
                    type="checkbox"
                    v-model="formData.weight_loss_ongoing"
                    :disabled="
                      formData.weight_loss !== 'Yes' ||
                ...
                <td>
                  <input
                    type="checkbox"
                    v-model="formData.weight_loss_resolved"
                    :disabled="
                      formData.weight_loss !== 'Yes' ||
              ...
              <tr>
                ...
                <td colspan="2">
                  <input
                    type="text"
                    v-model="formData.other_symptoms_specified"
        ...
        <div class="form-container" id="daily_prep">
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                v-model="formData.prep_reason"
                name="prep_reason"
                value="Risk of getting HIV"
              />
              High risk</label
            >
            <label
            ...
            >
            <textarea
              v-if="formData.prep_reason === 'Other'"
          ...
          <div class="radio-group-vertical">
            ...
            <input
              type="text"
              v-if="formData.pill_time === 'Other'"
              v-model="formData.pill_time_other"
              placeholder="Specify"
            />
          </div>
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                v-model="formData.pill_frequency"
                name="pill_freq"
                value="Always"
              />
              Always</label
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                v-model="formData.pill_reminder"
                name="pill_reminder"
                value="Nothing"
              />
              Nothing</label
            ...
            <input
              type="text"
              v-if="formData.pill_reminder === 'Other'"
              v-model="formData.pill_reminder_other"
              placeholder="Specify"
            />
          </div>
          ...
          <div class="checkbox-group-vertical">
            <label
              ><input
                type="checkbox"
                v-model="formData.missed_pill_reasons"
                value="N/A"
              />
            ...
            <input
              type="text"
              v-if="formData.missed_pill_reasons.includes('Other')"
              v-model="formData.missed_pill_other_reason"
              placeholder="Specify"
            />
          </div>

          <label for="longest_no_pill"
            >5.a.6 Longest missed streak (days)?</label
          >
          <input
            type="number"
            id="longest_no_pill"
            v-model.number="formData.longest_no_pill"
            min="0"
            placeholder="Days"
          />
          ...
          <input
            type="number"
            id="total_no_pill_days"
            v-model.number="formData.total_no_pill_days"
            min="0"
            placeholder="Days"
          />
        </div>
        ...
        <div class="form-container">
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                v-model="formData.ed_prep_reason"
                name="ed_reason"
                value="Plan sexual events"
              />
            ...
            >
            <textarea
              v-if="formData.ed_prep_reason === 'Other'"
              v-model="formData.other_ed_prep_reason"
              rows="3"
              placeholder="Specify"
            ></textarea>
          </div>
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                v-model="formData.sex_last_month"
                name="sex_last_m"
                value="Did not have sex"
              />
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                name="prep_before_m"
                v-model="formData.prep_before_sex"
                value="0%"
              />
              0%</label
            >
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                name="prep_after_m"
                v-model="formData.prep_after_sex"
                value="0%"
              />
              0%</label
            >
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                name="first_after_m"
                v-model="formData.first_prep_after_sex"
                value="0%"
              />
              0%</label
            >
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                name="second_after_m"
                v-model="formData.second_prep_after_sex"
                value="0%"
              />
              0%</label
            >
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                name="sex_last_w"
                v-model="formData.sex_last_week"
                value="None"
              />
              None</label
            >
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                name="prep_before_w"
                v-model="formData.prep_before_sex_week"
                value="0%"
              />
              0%</label
            >
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                name="first_after_w"
                v-model="formData.first_prep_after_sex_week"
                value="0%"
              />
              0%</label
            >
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                name="second_after_w"
                v-model="formData.second_prep_after_sex_week"
                value="0%"
              />
              0%</label
            >
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                v-model="formData.prep_before_last_sex"
                name="prep_before_last"
            ...
            >
            <textarea
              v-if="formData.prep_before_last_sex === 'Other'"
              v-model="formData.prep_before_last_sex_other"
              rows="3"
              placeholder="Specify"
            ></textarea>
          </div>
          ...
          <div class="radio-group-vertical">
            <label
              ><input
                type="radio"
                v-model="formData.prep_after_last_sex"
                name="prep_after_last"
                value="Did not take PrEP"
              />
              Didn't take</label
            >
            ...
            >
            <textarea
              v-if="formData.prep_after_last_sex === 'Other'"
              v-model="formData.prep_after_last_sex_other"
              rows="3"
              placeholder="Specify"
            ></textarea>
          </div>
      ...
      <div class="form-container">
        ...
        <div class="checkbox-group-vertical">
          <label
            ><input
              type="checkbox"
              v-model="formData.pill_remember"
              value="Nothing"
            />
            Nothing</label
          >
          ...
          <label
            ><input
              type="checkbox"
              v-model="formData.pill_remember"
              value="Association with having sex"
            />
            Assoc. w/ sex</label
          >
          <label
          ...
          >
          <textarea
            v-if="formData.pill_remember.includes('Other')"
            v-model="formData.pill_remember_other"
            rows="3"
            placeholder="Specify"
          ></textarea>
        </div>
        ...
        <div class="checkbox-group-vertical">
          <label
            ><input
              type="checkbox"
              v-model="formData.pill_missed"
              value="Did not miss pills"
            />
            Did not miss</label
          >
          <label
            ><input
              type="checkbox"
              v-model="formData.pill_missed"
              value="Did not have pills with me"
            />
        ...
        <div class="checkbox-group-vertical">
          <label
            ><input
              type="checkbox"
              v-model="formData.pill_missed_experiences"
          ...
          >
          <textarea
            v-if="formData.pill_missed_experiences.includes('Other')"
            v-model="formData.pill_missed_experiences_other"
            rows="3"
            placeholder="Specify"
          ></textarea>
        </div>
      ...
      <div class="form-container">
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              name="pill_remember_difficulty"
              v-model="formData.pill_remember_difficulty"
              value="Very easy"
              required
            />
            Very easy</label
        ...
        <div class="checkbox-group-vertical">
          <label
            ><input
              type="checkbox"
              v-model="formData.pill_recipient"
              value="Partner"
            />
            Partner</label
          >
          ...
          >
          <textarea
            v-if="formData.pill_recipient.includes('Other')"
            v-model="formData.pill_recipient_other"
            rows="3"
            placeholder="Specify"
          ></textarea>
        </div>
      ...
      <div class="form-container">
        ...
        <label
          >9.1 Visited Pride Bhutan office (last 3m, non-PrEP reasons)?</label
        >
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label
            style="
            ...
            ><input
              type="radio"
              v-model="formData.visited_pride_bhutan"
              name="visit_pride"
              value="Yes"
              required
            />
        ...
        <div
          v-if="formData.visited_pride_bhutan === 'Yes'"
        ...
        >
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label
              ><input
                type="radio"
                name="pride_hiv"
                v-model="formData.hiv_testing_reason"
                value="Yes"
              />
              Y</label
            ><label
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label
              ><input
                type="radio"
                name="pride_sti"
                v-model="formData.sti_testing_reason"
                value="Yes"
              />
              Y</label
            ><label
          ...
          <textarea
            v-model="formData.other_reason_visited"
            rows="2"
            placeholder="Specify"
          ></textarea>
        </div>
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label
            ><input
              type="radio"
              v-model="formData.received_condoms"
              name="recv_condoms"
              value="Yes"
              required
            />
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label
            ><input
              type="radio"
              v-model="formData.received_lubricants"
              name="recv_lube"
              value="Yes"
              required
            />
      ...
      <div class="form-container">
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label
            ><input
              type="radio"
              v-model="formData.consumed_alcohol"
              name="consume_alc"
              value="Yes"
              required
            />
        ...
        <div
          v-if="formData.consumed_alcohol === 'Yes'"
          class="conditional-section"
        >
          <label for="alcohol_days"
            >10.2 Days consumed alcohol (last week)?</label
          >
          <input
            type="number"
            id="alcohol_days"
            v-model.number="formData.alcohol_days"
            min="0"
            placeholder="Days"
            required
          />
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label
              ><input
                type="radio"
                name="alc_sex"
                v-model="formData.alcohol_before_during_sex"
                value="Yes"
                required
              />
              Yes</label
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label
              ><input
                type="radio"
                name="drugs_sex"
                v-model="formData.drugs_before_during_sex"
                value="Yes"
                required
              />
              Yes</label
      ...
      <div class="form-container">
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.protection_feeling"
              name="prot_feel"
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.prep_package_opinion"
              name="pkg_opinion"
              value="I think it is necessary"
              required
            />
            Necessary</label
          >
        ...
        <div class="checkbox-group-vertical">
          <label
            ><input
              type="checkbox"
              v-model="formData.participation_likes"
          ...
          <label
            ><input
              type="checkbox"
              v-model="formData.participation_likes"
              value="Routine visit to the doctor"
            />
          ...
          >
          <textarea
            v-if="formData.participation_likes.includes('Other')"
            v-model="formData.participation_likes_other"
            rows="3"
            placeholder="Specify"
          ></textarea>
        </div>
        ...
        <div class="checkbox-group-vertical">
          <label
            ><input
              type="checkbox"
              v-model="formData.participation_challenges"
              value="No challenges faced"
            />
            No challenges</label
          >
          <label
          ...
          >
          <textarea
            v-if="formData.participation_challenges.includes('Other')"
            v-model="formData.participation_challenges_other"
            rows="3"
            placeholder="Specify"
          ></textarea>
        </div>
        ...
        <div class="checkbox-group-vertical">
          ...
          <label
            ><input
              type="checkbox"
              v-model="formData.delivery_preference"
              value="Availability at Pharmacies"
            />
            Pharmacies</label
          >
          <label
          ...
          >
          <textarea
            v-if="formData.delivery_preference.includes('Other methods')"
            v-model="formData.delivery_preference_other"
            rows="3"
            placeholder="Specify"
          ></textarea>
        </div>
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.satisfaction_level"
              name="satisfaction"
      ...
      <div class="form-container">
        ...
        <label
          >12.1 What are the reasons for discontinuing PrEP? (Check all)</label
        >
        <div class="checkbox-group-vertical">
          <label
            ><input
              type="checkbox"
              v-model="formData.discontinuation_reasons"
          ...
          <label
            ><input
              type="checkbox"
              v-model="formData.discontinuation_reasons"
              value="Developed kidney problems"
            />
          ...
          >
          <textarea
            v-if="formData.discontinuation_reasons.includes('Other')"
            v-model="formData.discontinuation_other"
            rows="3"
...
const GOOGLE_SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbz6ugkpSN8qWytGVod4uUlsSN5asjN-ggBFyknbzowVyrthEcl2X4DVfvG-wdnj34Hh/exec"; // FORM 6 URL
const CSV_DATA_URL =
...
const confirmAndSubmit = async () => {
  ...
  try {
    ...
    modalSuccessMessage.value =
      "Form submitted successfully (response not readable).";
    setTimeout(() => {
      isReviewModalVisible.value = false;
