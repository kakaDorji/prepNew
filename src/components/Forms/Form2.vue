<template>
  ...
  <form @submit.prevent="showReviewModal">
    ...
    <div class="container">
      ...
      <div class="form-container">
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              ...
              margin-bottom: 0;
            ">
            <input type="radio" v-model="formData.interview_status" id="progress" name="interview_status"
          ...
          <label style="
              ...
              margin-bottom: 0;
            ">
            <input type="radio" v-model="formData.interview_status" id="terminate" name="interview_status"
              value="Terminate" required />
            Terminate
          </label>
        </div>
      </div>
      ...
      <div class="form-container">
        ...
        <input type="number" v-model.number="formData.birth_year" id="birth_year" name="birth_year" required min="1900"
          :max="new Date().getFullYear()" placeholder="Enter 4-digit year" />
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.permanent_bhutan" value="Yes" required />
            Yes</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.permanent_bhutan" value="No" required />
            No</label>
        </div>
        ...
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.occupation" name="occupation" value="None" required />
            None</label>
          <label><input type="radio" v-model="formData.occupation" name="occupation" value="Student" required />
            Student</label>
          <label><input type="radio" v-model="formData.occupation" name="occupation" value="Fulltime job" required />
            Fulltime job (Government / Private / NGO/ CSO)</label>
          <label><input type="radio" v-model="formData.occupation" name="occupation" value="Parttime job" required />
            Part-time job</label>
          <label><input type="radio" v-model="formData.occupation" name="occupation" value="Other" required />
            Other</label>
          <!-- Input field to specify occupation -->
          <input type="text" v-if="formData.occupation === 'Other'" v-model="formData.occupation_specify"
            id="occupation_specify" name="occupation_specify" placeholder="Please specify your occupation" />
          <label><input type="radio" v-model="formData.occupation" name="occupation" value="No response" required />
            No response</label>
        </div>
        ...
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.education" name="education" value="None" required />
            None</label>
          <label><input type="radio" v-model="formData.education" name="education" value="Primary School" required />
            Primary School (till Class 6)</label>
          <label><input type="radio" v-model="formData.education" name="education" value="Lower Secondary" required />
            Lower Secondary (till Class 8)</label>
          <label><input type="radio" v-model="formData.education" name="education" value="Middle Secondary" required />
            Middle Secondary School (till Class 10)</label>
          <label><input type="radio" v-model="formData.education" name="education" value="Higher Secondary" required />
            Higher Secondary School (till Class 12)</label>
          <label><input type="radio" v-model="formData.education" name="education" value="Vocational School or College"
              required />
            Vocational School/College</label>
          <label><input type="radio" v-model="formData.education" name="education" value="University" required />
            University (Bachelor’s Degree and above)</label>
          <label><input type="radio" v-model="formData.education" name="education" value="No response" required />
            No response</label>
        </div>
        ...
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.marital_status" name="marital_status" value="Never married"
              required />
            Never married</label>
          <label><input type="radio" v-model="formData.marital_status" name="marital_status" value="Currently married"
              required />
            Currently married</label>
          <label><input type="radio" v-model="formData.marital_status" name="marital_status" value="Widowed" required />
            Widowed</label>
          ...
          <label><input type="radio" v-model="formData.marital_status" name="marital_status" value="Separated"
              required />
            Separated</label>
          <label><input type="radio" v-model="formData.marital_status" name="marital_status" value="Other" required />
            Other</label>
          <!-- Input field to specify marital status -->
          <input type="text" v-if="formData.marital_status === 'Other'" v-model="formData.marital_specify"
            id="marital_specify" name="marital_specify" placeholder="Please specify your marital status" />
        </div>
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.living_with_partner" value="Yes" required />
            Yes</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.living_with_partner" value="No" required />
            No</label>
        </div>

        <!-- 1.7 Sex Partner's Gender -->
        <label>1.7 If so, is your sex partner MSM, FSW, or TG? (tick all that
          apply)</label>
        ...
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.sexual_orientation" name="sexual_orientation"
              value="Gay/homosexual" required />
            Gay/homosexual</label>
          <label><input type="radio" v-model="formData.sexual_orientation" name="sexual_orientation" value="Bisexual"
              required />
            Bisexual</label>
          <label><input type="radio" v-model="formData.sexual_orientation" name="sexual_orientation"
              value="Heterosexual" required />
            Heterosexual</label>
          <label><input type="radio" v-model="formData.sexual_orientation" name="sexual_orientation" value="Other"
              required />
            Other</label>
          <!-- Input field to specify sexual orientation -->
          <input type="text" v-if="formData.sexual_orientation === 'Other'" v-model="formData.orientation_specify"
            id="orientation_specify" name="orientation_specify" placeholder="Please specify your sexual orientation" />
        </div>
      </div>
      ...
      <div class="form-container">
        ...
        <label>2.1 In general, to what extent do you consider yourself at risk of
          getting HIV?</label>
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.hiv_risk" name="hiv_risk" value="Very Low Risk" required />
            1 - Very Low Risk</label>
          <label><input type="radio" v-model="formData.hiv_risk" name="hiv_risk" value="Low Risk" required />
            2 - Low Risk</label>
          <label><input type="radio" v-model="formData.hiv_risk" name="hiv_risk" value="Medium Risk" required />
            3 - Medium Risk</label>
          <label><input type="radio" v-model="formData.hiv_risk" name="hiv_risk" value="High Risk" required />
            4 - High Risk</label>
          <label><input type="radio" v-model="formData.hiv_risk" name="hiv_risk" value="Very High Risk" required />
        ...
        <label>2.2 In general, to what extent do you consider yourself at risk of
          getting STI?</label>
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.sti_risk" name="sti_risk" value="Very Low Risk" required />
            1 - Very Low Risk</label>
          <label><input type="radio" v-model="formData.sti_risk" name="sti_risk" value="Low Risk" required />
            2 - Low Risk</label>
          <label><input type="radio" v-model="formData.sti_risk" name="sti_risk" value="Medium Risk" required />
            3 - Medium Risk</label>
          <label><input type="radio" v-model="formData.sti_risk" name="sti_risk" value="High Risk" required />
            4 - High Risk</label>
          <label><input type="radio" v-model="formData.sti_risk" name="sti_risk" value="Very High Risk" required />
            5 - Very High Risk</label>
        </div>

        <label>2.3 In general, how do you manage your risk of getting HIV?</label>
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.hiv_management" name="hiv_management"
              value="Ask partner to use condom" required />
            I frequently ask my partner/client to use a condom during sex</label>
          <label><input type="radio" v-model="formData.hiv_management" name="hiv_management" value="Use condom"
              required />
            I frequently use condoms</label>
          <label><input type="radio" v-model="formData.hiv_management" name="hiv_management"
              value="Choose HIV negative partner" required />
            I choose partner based on their HIV negative status</label>
          <label><input type="radio" v-model="formData.hiv_management" name="hiv_management"
              value="Seek partner on HIV treatment" required />
            I seek partners who I know are on HIV treatment</label>
          <label><input type="radio" v-model="formData.hiv_management" name="hiv_management" value="Be top when unsure"
              required />
            I try to be top if I’m not sure about my partner’s HIV status</label>
          <label><input type="radio" v-model="formData.hiv_management" name="hiv_management" value="No strategy"
              required />
            I don’t use any risk reduction strategy</label>
          <label><input type="radio" v-model="formData.hiv_management" name="hiv_management" value="Other" required />
            Other</label>
          <input type="text" v-if="formData.hiv_management === 'Other'" v-model="formData.other_hiv_management_specify"
            name="other_hiv_management_specify" placeholder="Please specify your strategy" />
        </div>

        <label>2.4 Do you know the HIV status of your partner (male, female, TGW)?
          Will you share with us?</label>
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.partner_hiv_status" name="partner_hiv_status" value="No"
              required />
          ...
          <label><input type="radio" v-model="formData.partner_hiv_status" name="partner_hiv_status"
              value="Not HIV positive" required />
            Yes, my partner is NOT HIV positive</label>
          <label><input type="radio" v-model="formData.partner_hiv_status" name="partner_hiv_status"
              value="Positive and on ART" required />
            Yes, my partner is HIV positive and on ART</label>
          <label><input type="radio" v-model="formData.partner_hiv_status" name="partner_hiv_status"
              value="Positive but not on ART" required />
      ...
      <div class="form-container">
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.steady_partners" value="Yes" required />
            Yes</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.steady_partners" value="No" required />
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.casual_partners" value="Yes" required />
            Yes</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.casual_partners" value="No" required />
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.transactional_partners" value="Yes" required />
            Yes</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.transactional_partners" value="No" required />
            No (IF NO SKIP ALL questions on TRANSACTIONAL Partners)</label>
        </div>

        <label>3.4 Can you tell the number of various partners you had anal sex with
        ...
        <div class="radio-group-vertical" style="margin-top: 10px">
          <label><input type="radio" v-model="formData.anal_sex" name="anal_sex_status" value="No anal sex" :disabled="formData.steady_anal_partners > 0 ||
            formData.casual_anal_partners > 0 ||
            formData.transactional_anal_partners > 0
            " required />
            I never have anal sex
          </label>
          <label><input type="radio" v-model="formData.anal_sex" name="anal_sex_status" value="No response" :disabled="formData.steady_anal_partners > 0 ||
            formData.casual_anal_partners > 0 ||
            formData.transactional_anal_partners > 0
            " required />
            No Response
        ...
        <label>3.5 Can you tell the number of various partners you had vaginal sex
        ...
        <div v-if="formData.transactional_partners === 'Yes'" class="partner-count">
          ...
          <input type="number" v-model.number="formData.transactional_vaginal_partners" id="transactional_vaginal"
            min="0" />
        </div>
        <div class="radio-group-vertical" style="margin-top: 10px">
          <label><input type="radio" v-model="formData.vaginal_sex" name="vaginal_sex_status" value="No vaginal sex"
              :disabled="formData.steady_vaginal_partners > 0 ||
      ...
      <div class="form-container">
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.ever_had_sex" value="Yes" required />
            Yes</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.ever_had_sex" value="No" required />
        ...
        <div v-if="formData.ever_had_sex === 'Yes'" style="margin-top: 20px">
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.sex_last_six_months" value="Yes" required />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.sex_last_six_months" value="No" required />
              No</label>
          </div>

          <label>4.3 How often did you use a condom during the last vaginal or anal
            sex?</label>
          <div class="radio-group-vertical">
            <label><input type="radio" v-model="formData.condom_frequency" name="condom_frequency" value="Always"
                required />
              Always (100%)</label>
            <label><input type="radio" v-model="formData.condom_frequency" name="condom_frequency"
                value="Most of the time" required />
              Most of the time (75%)</label>
            <label><input type="radio" v-model="formData.condom_frequency" name="condom_frequency"
                value="About half the time" required />
              About half the time (50%)</label>
            <label><input type="radio" v-model="formData.condom_frequency" name="condom_frequency" value="Sometimes"
                required />
              Sometimes (25%)</label>
            <label><input type="radio" v-model="formData.condom_frequency" name="condom_frequency" value="Rarely"
                required />
              Rarely (below 10%)</label>
            <label><input type="radio" v-model="formData.condom_frequency" name="condom_frequency" value="Never"
                required />
              Never</label>
          </div>
        </div>
      ...
      <div class="form-container">
        ...
        <label>5.1 In the last one week, how often did you use a condom with your
          steady partner/s?</label>
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.steady_condom_use" name="steady_condom_use" value="Always"
              required />
            Always (100%)</label>
          <label><input type="radio" v-model="formData.steady_condom_use" name="steady_condom_use"
              value="Most of the time" required />
            Most of the time (75%)</label>
          <label><input type="radio" v-model="formData.steady_condom_use" name="steady_condom_use"
              value="About half the time" required />
            About half the time (50%)</label>
          <label><input type="radio" v-model="formData.steady_condom_use" name="steady_condom_use" value="Sometimes"
              required />
            Sometimes (25%)</label>
          <label><input type="radio" v-model="formData.steady_condom_use" name="steady_condom_use" value="Rarely"
              required />
            Rarely (below 10%)</label>
          <label><input type="radio" v-model="formData.steady_condom_use" name="steady_condom_use" value="Never"
              required />
            Never</label>
          <label><input type="radio" v-model="formData.steady_condom_use" name="steady_condom_use"
              value="No sex last week" required />
            I did not have sex with my steady partner last week.</label>
        </div>

        <label>5.2 In the last one week, how often did you use a condom with your
          Casual partner/s?</label>
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.casual_condom_use" name="casual_condom_use" value="Always"
              required />
            Always (100%)</label>
          <label><input type="radio" v-model="formData.casual_condom_use" name="casual_condom_use"
              value="Most of the time" required />
            Most of the time (75%)</label>
          <label><input type="radio" v-model="formData.casual_condom_use" name="casual_condom_use"
              value="About half the time" required />
            About half the time (50%)</label>
          <label><input type="radio" v-model="formData.casual_condom_use" name="casual_condom_use" value="Sometimes"
              required />
            Sometimes (25%)</label>
          <label><input type="radio" v-model="formData.casual_condom_use" name="casual_condom_use" value="Rarely"
              required />
            Rarely (below 10%)</label>
          <label><input type="radio" v-model="formData.casual_condom_use" name="casual_condom_use" value="Never"
              required />
            Never</label>
          <label><input type="radio" v-model="formData.casual_condom_use" name="casual_condom_use"
              value="No sex last week" required />
        ...
        <label>5.3 In the last one week, how often did you use a condom with your
          Transactional partner/s?</label>
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.transactional_condom_use" name="transactional_condom_use"
        ...
        <label>5.4 In the last sex act with your steady partner, did you use a
          condom?</label>
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              display: inline-flex;
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.steady_last_condom" value="YES" required />
            YES</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.steady_last_condom" value="NO" required />
            NO</label>
        </div>

        <label>5.5 In the last sex act with your Casual partner, did you use a
          condom?</label>
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              display: inline-flex;
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.casual_last_condom" value="YES" required />
            YES</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.casual_last_condom" value="NO" required />
            NO</label>
        </div>

        <label>5.6 In the last sex act with your Transactional partner, did you use
          a condom?</label>
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              display: inline-flex;
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.transactional_last_condom" value="YES" required />
            YES</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.transactional_last_condom" value="NO" required />
            NO</label>
        </div>

        <label>5.7 What were your reasons for having condomless sex? (You may select
          multiple answers)</label>
        <div class="checkbox-group-vertical">
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="Sex feels better without condom" />
            I do not think sex feels good with a condom</label>
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="Partner thinks sex feels better" />
            My partner does not think sex feels good with a condom</label>
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="Forget to use" />
            I forget to use</label>
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="No condoms available" />
            I did not have or find any condoms.</label>
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="No time to buy" />
            There was no time to buy one</label>
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="No time to put on" />
            There was no time to put one on</label>
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="Know partner's status" />
            I know the HIV status of my partner/Client</label>
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="Too expensive" />
            I find it expensive</label>
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="Embarrassed to buy" />
            I am embarrassed to buy or ask for condoms</label>
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="Using other methods" />
            I use other methods to prevent HIV/STIs</label>
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="Do not trust condoms" />
            I do not trust condoms</label>
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="Trust my partner" />
            I trust my partner</label>
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="Was drunk" />
            I was drunk</label>
          <label><input type="checkbox" v-model="formData.condomless_reasons" value="Other reasons" />
            Other reasons, specify</label>
          <!-- Input for specifying 'Other reasons' -->
          <input type="text" v-if="formData.condomless_reasons.includes('Other reasons')"
            v-model="formData.other_condomless_reasons" placeholder="Please specify other reasons" />
        </div>

        <h3 class="section-title">LUBRICANT USE</h3>

        <label>5.8 Have you ever used gel or water-based lubricant during anal
          sex?</label>
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              display: inline-flex;
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.lubricant_used" name="lubricant_used" value="Yes" />
            Yes</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.lubricant_used" name="lubricant_used" value="No" />
            No (If NO Skip 5.9, 5.10)</label>
        </div>

        <div v-if="formData.lubricant_used === 'Yes'">
          <label>5.9 How often did you use gel or water-based lubricants for anal
            sex during the last 3 months?</label>
          <div class="radio-group-vertical">
            <label><input type="radio" v-model="formData.lubricant_frequency" name="lubricant_frequency"
                value="Always" />
              Always (100%)</label>
            <label><input type="radio" v-model="formData.lubricant_frequency" name="lubricant_frequency"
          ...
          <label>5.10 Why do you not always use gel or water-based lubricants for
            anal sex? (Multiple answers may be possible)</label>
          <div class="checkbox-group-vertical">
            <label><input type="checkbox" v-model="formData.lubricant_use_reasons" value="Do not find it necessary" />
              Do not find it necessary</label>
            <label><input type="checkbox" v-model="formData.lubricant_use_reasons" value="Partner refused" />
              My partner refused</label>
            <label><input type="checkbox" v-model="formData.lubricant_use_reasons" value="No lubricant available" />
              I did not have gel or water-based lubricants at that time.</label>
            <label><input type="checkbox" v-model="formData.lubricant_use_reasons" value="Not easily available" />
              Gel or water-based lubricants are not easily available.</label>
            <label><input type="checkbox" v-model="formData.lubricant_use_reasons" value="Expensive" />
              Gel or water-based lubricants are expensive</label>
            <label><input type="checkbox" v-model="formData.lubricant_use_reasons" value="Prefer other lubricants" />
              I prefer to use other types of lubricants.</label>
            <label><input type="checkbox" v-model="formData.lubricant_use_reasons" value="Prefer other products" />
              I prefer to use other products to improve penetration.</label>
            <label><input type="checkbox" v-model="formData.lubricant_use_reasons" value="No response" />
              No response.</label>
            <label><input type="checkbox" v-model="formData.lubricant_use_reasons" value="Other reasons" />
              Others reason, specify</label>
            <!-- Input for 'Other' lubricant reasons -->
            <input type="text" v-if="formData.lubricant_use_reasons.includes('Other reasons')"
              v-model="formData.other_lubricant_reasons" placeholder="Please specify other reasons" />
          </div>
        </div>
      </div>
      ...
      <div class="form-container">
        ...
        <label>6.1 In the past 12 months, have you met outreach workers from
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.outreach_workers" name="outreach_workers" value="Yes" />
            Yes</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.outreach_workers" name="outreach_workers" value="No" />
        ...
        <div v-if="formData.outreach_workers === 'Yes'" class="conditional-section">
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.hiv_prevention" value="Yes" />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.hiv_prevention" value="No" />
              No</label>
          </div>
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.sti_discussion" value="Yes" />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.sti_discussion" value="No" />
              No</label>
          </div>
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.condoms_lubricants" value="Yes" />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.condoms_lubricants" value="No" />
              No</label>
          </div>
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.prep_discussion" value="Yes" />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.prep_discussion" value="No" />
              No</label>
          </div>
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.general_wellbeing" value="Yes" />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.general_wellbeing" value="No" />
              No</label>
          </div>
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.stigma_issues" value="Yes" />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.stigma_issues" value="No" />
              No</label>
          </div>
        ...
        <label>6.2 Have you ever visited Pride Bhutan Office in the last 12
          months?</label>
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              display: inline-flex;
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.visited_pride_office" value="Yes" />
            Yes</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.visited_pride_office" value="No" />
            No (If NO skip Q6.2.a till 6.2.d)</label>
        </div>

        <div v-if="formData.visited_pride_office === 'Yes'" class="conditional-section">
          <label>6.2.a What were the reasons for visiting the Pride Bhutan
            Office?</label>
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.pride_hiv_test" value="Yes" />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.pride_hiv_test" value="No" />
              No</label>
          </div>
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.pride_sti_test" value="Yes" />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.pride_sti_test" value="No" />
              No</label>
          </div>
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.pride_condoms_lubricants" value="Yes" />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.pride_condoms_lubricants" value="No" />
              No</label>
          </div>
        ...
        <label>6.3 Have you ever visited HISC or any other hospitals in the last 12
          months?</label>
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              display: inline-flex;
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.visited_hisc_thimphu" value="Yes" />
            Yes</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.visited_hisc_thimphu" value="No" />
        ...
        <div v-if="formData.visited_hisc_thimphu === 'Yes'" class="conditional-section">
          ...
          > -->
          <label>6.3 In the last 12 months, have you ever visited a hospital or HISC
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.hisc_hiv_test" value="Yes" />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.hisc_hiv_test" value="No" />
              No</label>
          </div>
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.hisc_sti_test" value="Yes" />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.hisc_sti_test" value="No" />
              No</label>
          </div>
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.hisc_condoms_lubricants" value="Yes" />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.hisc_condoms_lubricants" value="No" />
              No</label>
          </div>
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.hisc_general_checkup" value="Yes" />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.hisc_general_checkup" value="No" />
              No</label>
          </div>
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.tested_hiv" name="tested_hiv" value="Yes" />
            Yes</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.tested_hiv" name="tested_hiv" value="No" />
        ...
        <div v-if="formData.tested_hiv === 'Yes'" class="conditional-section">
          ...
          <div class="radio-group-vertical">
            <label><input type="radio" v-model="formData.last_tested_hiv" name="last_tested_hiv" value="12 months" />
              12 months</label>
            <label><input type="radio" v-model="formData.last_tested_hiv" name="last_tested_hiv" value="6-12 months" />
              6-12 months</label>
            <label><input type="radio" v-model="formData.last_tested_hiv" name="last_tested_hiv"
                value="Less than 6 months" />
              Less than 6 months</label>
            <label><input type="radio" v-model="formData.last_tested_hiv" name="last_tested_hiv"
                value="Do not remember/do not know" />
              Do not remember/do not know</label>
            <label><input type="radio" v-model="formData.last_tested_hiv" name="last_tested_hiv" value="No response" />
              No response</label>
          </div>

          <label>6.6 Do you know your HIV status? Will you be willing to share with
            us?</label>
          <div class="radio-group-vertical">
            <label><input type="radio" v-model="formData.know_hiv_status" name="know_hiv_status"
        ...
        <label>6.7 In the past 6 months, have you ever experienced any of these
          symptoms of STI? (Tick multiple responses)</label>
        <div class="checkbox-group-vertical">
          <label><input type="checkbox" v-model="formData.sti_symptoms" value="Discharge from vagina/penis/anus" />
            Discharge from vagina/penis/anus</label>
          <label><input type="checkbox" v-model="formData.sti_symptoms" value="Pain while peeing" />
            Pain while peeing</label>
          <label><input type="checkbox" v-model="formData.sti_symptoms"
              value="Lumps or bumps around genitals or anus" />
            Lumps or bumps around genitals or anus</label>
          <label><input type="checkbox" v-model="formData.sti_symptoms" value="Unusual vaginal bleeding" />
            Unusual vaginal bleeding</label>
          <label><input type="checkbox" v-model="formData.sti_symptoms" value="Itchy genitals or anus" />
          ...
          <label><input type="checkbox" v-model="formData.sti_symptoms" value="None" />
            None</label>
        </div>

        <div v-if="!formData.sti_symptoms.includes('None')">
          <label>6.8 The last time you had any of these symptoms what did you
            do?</label>
          <div class="radio-group-vertical">
            <label><input type="radio" v-model="formData.action_taken" name="action_taken"
            ...
            <label><input type="radio" v-model="formData.action_taken" name="action_taken" value="Other (specify)" />
              Other (specify)</label>
            <!-- Input for 'Other' action -->
            <input type="text" v-if="formData.action_taken === 'Other (specify)'" v-model="formData.other_action_taken"
      ...
      <div class="form-container">
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.alcohol_consumed" name="alcohol_consumed" value="Yes" required />
            Yes</label>
          <label style="
              display: inline-flex;
              align-items: center;
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.alcohol_consumed" name="alcohol_consumed" value="No" />
            No (If No, skip 7.2)</label>
        </div>

        <div v-if="formData.alcohol_consumed === 'Yes'" class="conditional-section">
          <label for="days_consumed_alcohol">7.2 How many days did you consume alcohol in the past one
            week?</label>
          <input type="number" v-model.number="formData.days_consumed_alcohol" id="days_consumed_alcohol"
            placeholder="Number of days" min="0" />
        </div>

        <label>7.3 The last time you had sex with any of your sexual partners, did
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label style="
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.alcohol_before_sex" name="alcohol_before_sex" value="Yes"
              required />
            Yes</label>
          <label style="
              display: inline-flex;
              ...
              font-weight: normal;
              margin-bottom: 0;
            "><input type="radio" v-model="formData.alcohol_before_sex" name="alcohol_before_sex" value="No" />
        ...
        <div v-if="formData.alcohol_before_sex === 'Yes'" class="conditional-section">
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.recreational_drugs" name="recreational_drugs" value="Yes"
                required />
              Yes</label>
            <label style="
                display: inline-flex;
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.recreational_drugs" name="recreational_drugs" value="No" />
              No</label>
          </div>

          <label>7.5 The last time you had sex with any of your sexual partners, did
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 1rem">
            <label style="
                ...
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.drugs_before_sex" name="drugs_before_sex" value="Yes" required />
              Yes</label>
            <label style="
                display: inline-flex;
                align-items: center;
                font-weight: normal;
                margin-bottom: 0;
              "><input type="radio" v-model="formData.drugs_before_sex" name="drugs_before_sex" value="No" />
              No</label>
          </div>
        </div>
      </div>
      ...
      <div class="form-container">
        ...
        <label>8.1 Have you ever been denied health or medical services because you
          belong to KP groups (FSW, MSM, MSW, and TG person)?</label>
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.denied_services" name="denied_services" value="Yes, only once"
              required />
            Yes, only once</label>
          <label><input type="radio" v-model="formData.denied_services" name="denied_services"
              value="Yes, multiple times" />
            Yes, multiple times</label>
          <label><input type="radio" v-model="formData.denied_services" name="denied_services" value="No, never" />
            No, never</label>
          <label><input type="radio" v-model="formData.denied_services" name="denied_services" value="No response" />
            No response</label>
        </div>

        <label>8.2 Have you ever been exposed to violence or abuse from the police
          because you belong to a KP group?</label>
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.violence_police" name="violence_police" value="Yes, only once"
              required />
            Yes, only once</label>
          <label><input type="radio" v-model="formData.violence_police" name="violence_police"
              value="Yes, multiple times" />
            Yes, multiple times</label>
          <label><input type="radio" v-model="formData.violence_police" name="violence_police" value="No, never" />
            No, never</label>
          <label><input type="radio" v-model="formData.violence_police" name="violence_police" value="No response" />
            No response</label>
        </div>

        <label>8.3 In the last 12 months, were you forced to have sexual intercourse
          even if you did not want to?</label>
        <div class="radio-group-vertical">
          <label><input type="radio" v-model="formData.forced_intercourse" name="forced_intercourse"
              value="Yes, only once" required />
            Yes, only once</label>
          <label><input type="radio" v-model="formData.forced_intercourse" name="forced_intercourse"
              value="Yes, multiple times" />
            Yes, multiple times</label>
        ...
        ">
          ...
          <div class="checkbox-group-vertical">
            <label>
              <input type="checkbox" v-model="formData.informed_person" value="Did not tell anyone" />
              Did not tell anyone
            </label>
            <label>
              <input type="checkbox" v-model="formData.informed_person" value="Fellow MSM, TG, FSW" />
              Fellow MSM, TG, FSW
            </label>
            <label>
              <input type="checkbox" v-model="formData.informed_person"
                value="Friend/Relative/Family Member who is not MSM/TG/FSW" />
              Friend / Relative / Family Member who is not MSM/TG/FSW
            </label>
            <label>
              <input type="checkbox" v-model="formData.informed_person" value="NGO/CSO worker" />
              NGO/CSO worker
            </label>
            <label>
              <input type="checkbox" v-model="formData.informed_person" value="Police" />
              Police
            </label>
            <label>
              <input type="checkbox" v-model="formData.informed_person" value="I don’t remember" />
              I Don’t remember
            </label>
            <label>
              <input type="checkbox" v-model="formData.informed_person" value="Others" />
              Others
            </label>
            <input type="text" v-if="formData.informed_person.includes('Others')" v-model="formData.other_informed"
  ...
  <!-- Confirmation Modal -->
  <Form2_ConfirmationModal v-if="isReviewModalVisible" :formData="formData" :isSubmitting="isSubmitting"
...
.checkbox-group-vertical label {
  font-weight: normal;
  display: inline-flex;
  /* Align items in label */
  align-items: center;
  margin-bottom: 0;
  /* Remove bottom margin within group */
}
