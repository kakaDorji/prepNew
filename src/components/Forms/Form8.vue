  ...
  <form @submit.prevent="showReviewModal">
    ...
    <div class="container">
      ...
      <div class="form-container">
        ...
        <div
          style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 1rem"
        >
          <label
            style="
              display: inline-flex;
        ...
        <input
          type="date"
          v-model="formData.hiv_test_date"
          id="hiv_test_date"
          name="hiv_test_date"
          required
        />
        ...
        <label
          >At the time of HIV + Test result, is the client still on PrEP?</label
        >
        <div style="display: flex; gap: 20px; margin-bottom: 1rem">
          <label
            style="
            ...
            ><input
              type="radio"
              v-model="formData.client_on_prep"
              name="client_on_prep"
              value="Yes"
              required
            />
        ...
        <div v-if="formData.client_on_prep === 'No'">
          <label for="last_prep_taken"
            >If No, when was the last PrEP taken? (Date)</label
          >
          <input
            type="date"
            v-model="formData.last_prep_taken"
            id="last_prep_taken"
            name="last_prep_taken"
          />
        </div>
      </div>
      ...
      <div
        v-if="formData.dosing_regimen === 'Daily PrEP'"
      ...
      >
        ...
        <label
          >IF SEROCONVERSION AT MONTH 1 VISIT: In the last 1 month, have you
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.seroconversion_month1"
              name="sero_m1"
        ...
        <label
          >IF SEROCONVERSION at other follow-up visit: In the last 3 months,
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.seroconversion_other_month"
              name="sero_m_other"
              value="Never missed a dose"
            />
            Never missed</label
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.daily_partner_hiv_status"
              name="daily_partner_stat"
              value="HIV Negative"
              required
            />
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.daily_condom_use"
              name="daily_condom"
              value="Always"
              required
            />
        ...
        <label for="daily_seroconversion_comments"
          >Write additional comments on the circumstances that led to
          seroconversion:</label
        >
        <textarea
          v-model="formData.daily_seroconversion_comments"
          id="daily_seroconversion_comments"
          name="seroconversion_comments"
          rows="4"
      ...
      <div v-if="formData.dosing_regimen === 'ED-PrEP'" class="form-container">
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.ed_prep_sex_times"
              name="ed_sex_times"
        ...
        <label
          >In the past month, approx. how many times/percentage did you take
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.ed_prep_before_sex"
              name="ed_before_sex"
              value="Always (100%)"
              required
            />
        ...
        <label
          >In the past month approx. how many times/percentage did you take 1st
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.ed_prep_after_sex"
              name="ed_first_after"
              value="Always (100%)"
              required
            />
        ...
        <label
          >In the past month approx. how many times/percentage did you take 2nd
          PrEP tablet after sex?</label
        >
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.ed_prep_2ndafter_sex"
              name="ed_second_after"
              value="Always (100%)"
              required
            />
            Always (100%)</label
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.ed_prep_partner_hiv_status"
              name="ed_partner_stat"
              value="HIV Negative"
              required
            />
            Partner HIV Negative</label
        ...
        <div class="radio-group-vertical">
          <label
            ><input
              type="radio"
              v-model="formData.ed_prep_condom_use"
              name="ed_condom"
              value="Always"
              required
            />
        ...
        <label for="ed_prep_seroconversion_comments"
          >Write additional comments on the circumstances that led to
          seroconversion:</label
        >
        <textarea
          v-model="formData.ed_prep_seroconversion_comments"
          id="ed_prep_seroconversion_comments"
          name="seroconversion_comments"
          rows="4"
          placeholder="Provide any additional comments..."
        ></textarea>
      ...
      <div class="form-container">
        ...
        <input
          type="date"
          v-model="formData.reporting_date"
          id="reporting_date"
          name="reporting_date"
          readonly
        />
        ...
        <input
          type="text"
          v-model="formData.bmhc_registration"
          id="clinician_bhmc_rep"
