...
// Column mapping for prefill (based on actual spreadsheet headers)
function getColumnMapping() {
  return {
    ...
    13: 'Abdominalcramps_Resolved',
    14: 'Fatigue',
    15: 'Fatigue_Ongoing',
    16: 'Fatigue_Resolved',
    17: 'Dizziness',
    18: 'Dizziness_Ongoing',
    19: 'Resolved', // Note: This seems to be missing "Dizziness_" prefix in your headers
    20: 'Headache',
    21: 'Headache_Ongoing',
    ...
    30: 'stop_or_continue',
    31: 'stopping_reason',
    32: 'stopping_indicatte_reasons_preferred_method',
    33: 'Other_notes',
...
function getPrefillData(uid) {
  try {
    ...
    // Backend to Frontend field mapping (spreadsheet column names to Vue.js form field names)
    const fieldMapping = {
      'uid': 'participant_uid',
      ...
      'stopping_indicatte_reasons_preferred_method': 'stopping_Preventionmethod',
      'Other_notes': 'other_notes',
      'Date': 'interviewer_date', // Interviewer date
...
// Create the row data array for unscheduled visit (matching exact spreadsheet column order)
function createRowData(e) {
  return [
    ...
    // Side effects (matching exact column names)
