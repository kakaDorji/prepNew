...
// Column mapping for prefill (based on your form structure)
function getColumnMapping() {
  return {
    ...
    39: 'change_regimen',
    40: 'reason_change',
    // Continue mapping for all your fields... (truncated for brevity)
    // You can extend this mapping for all 110+ columns if needed
  };
}
